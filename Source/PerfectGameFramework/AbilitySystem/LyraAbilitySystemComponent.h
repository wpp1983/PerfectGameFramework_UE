...
PERFECTGAMEFRAMEWORK_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Gameplay_AbilityInputBlocked);
 ...
 */
UCLASS()
class PERFECTGAMEFRAMEWORK_API ULyraAbilitySystemComponent : public UAbilitySystemComponent
{
	GENERATED_BODY()
