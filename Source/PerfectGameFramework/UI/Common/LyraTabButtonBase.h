...
#include "PerfectGameFramework/UI/Foundation/LyraButtonBase.h"
...
class PERFECTGAMEFRAMEWORK_API ULyraTabButtonBase : public ULyraButtonBase, public ILyraTabButtonInterface
{
	GENERATED_BODY()
