...
#include "PerfectGameFramework/System/GameplayTagStack.h"
 ...
 */
UCLASS(Config = Game)
class PERFECTGAMEFRAMEWORK_API ALyraPlayerState : public AModularPlayerState, public IAbilitySystemInterface, public ILyraTeamAgentInterface
{
	GENERATED_BODY()
