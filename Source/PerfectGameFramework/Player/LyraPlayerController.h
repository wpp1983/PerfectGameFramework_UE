...
#include "PerfectGameFramework/Camera/LyraCameraAssistInterface.h"
...
class PERFECTGAMEFRAMEWORK_API ALyraPlayerController : public ACommonPlayerController, public ILyraCameraAssistInterface, public ILyraTeamAgentInterface
{
	GENERATED_BODY()
