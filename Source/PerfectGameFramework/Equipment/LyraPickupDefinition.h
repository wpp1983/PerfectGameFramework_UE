...
class PERFECTGAMEFRAMEWORK_API ULyraPickupDefinition : public UDataAsset
{
	GENERATED_BODY()
...
class PERFECTGAMEFRAMEWORK_API ULyraWeaponPickupDefinition : public ULyraPickupDefinition
{
	GENERATED_BODY()
