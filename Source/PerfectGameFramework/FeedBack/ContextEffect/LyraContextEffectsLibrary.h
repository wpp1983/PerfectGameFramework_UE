...
struct PERFECTGAMEFRAMEWORK_API FLyraContextEffects
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PERFECTGAMEFRAMEWORK_API ULyraActiveContextEffects : public UObject
{
	GENERATED_BODY()
...
class PERFECTGAMEFRAMEWORK_API ULyraContextEffectsLibrary : public UObject
{
	GENERATED_BODY()
