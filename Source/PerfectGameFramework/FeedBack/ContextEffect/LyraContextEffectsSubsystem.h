...
class PERFECTGAMEFRAMEWORK_API ULyraContextEffectsSettings : public UDeveloperSettings
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PERFECTGAMEFRAMEWORK_API ULyraContextEffectsSet : public UObject
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PERFECTGAMEFRAMEWORK_API ULyraContextEffectsSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
