...
struct PERFECTGAMEFRAMEWORK_API FLyraContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct PERFECTGAMEFRAMEWORK_API FLyraContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct PERFECTGAMEFRAMEWORK_API FLyraContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct PERFECTGAMEFRAMEWORK_API FLyraContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
...
class PERFECTGAMEFRAMEWORK_API UAnimNotify_LyraContextEffects : public UAnimNotify
{
	GENERATED_BODY()
