 ...
 */
 ...
 class PERFECTGAMEFRAMEWORK_API ULyraContextEffectsInterface : public UInterface
 {
	 GENERATED_BODY()

 };
 
 class PERFECTGAMEFRAMEWORK_API ILyraContextEffectsInterface : public IInterface
 {
	 GENERATED_BODY()
