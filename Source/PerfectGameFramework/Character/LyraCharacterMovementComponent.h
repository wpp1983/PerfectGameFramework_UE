...
PERFECTGAMEFRAMEWORK_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Gameplay_MovementStopped);
 ...
 */
UCLASS(Config = Game)
class PERFECTGAMEFRAMEWORK_API ULyraCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
